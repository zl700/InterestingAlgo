The merge of mergeSort is not the hardest part of mergeSort, the hardest part is to cut down the needless operations (copy data from the original array in order to merge them)
the key idea is:
